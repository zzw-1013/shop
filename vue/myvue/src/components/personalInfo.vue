  ...
  <div class="userinfo">
    <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" >
      ...
      <el-form-item prop="status">
        <el-button plain round icon="el-icon-view" type="success" @click="submitForm('ruleForm')">保存</el-button>
        <el-button plain round icon="el-icon-view" v-if="this.ruleForm.status === '3'" v-model.trim="ruleForm.status" type="success" @click="shopmanage">店铺管理</el-button>
        <el-button plain round icon="el-icon-view" v-if="this.ruleForm.status !== '3'" v-model.trim="ruleForm.status" type="success" @click="shopregister">商家注册</el-button>
      </el-form-item>
    </el-form>
  </div>
</div>
