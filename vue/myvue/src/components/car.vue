  ...
  <div >
    <div>
      ...
      <el-container style="height: 600px; border: 5px solid #eee">
        <el-header  style="background-color: rgb(127,255,212)">
            <p6 style="margin-left: 10px;height: 500px;font-size:30px;">我的订单</p6>
            <el-button plain round icon="el-icon-view" type="success" style="margin-left: 20px" @click="usermanage">购物车</el-button>
             <el-button plain round icon="el-icon-view" type="success" @click="shopmanage" >已付款</el-button>
             <el-button plain round icon="el-icon-view" type="success" @click="goodmanage" >待收货</el-button>
        </el-header>
        <el-main style="height:0;flex-grow:1;">
            ...
            @row-click="openDetails" border>
                ...
                <el-table-column  width="80" label="操作">
                    <template slot-scope="scope">
                        <el-button size="mini" plain icon="el-icon-delete" type="danger" @click.native.prevent="deleteRow(scope.$index, tableData)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </el-main>
        <el-button style="margin-left: 10px; margin-top: 10px; width:100px"
        plain round icon="el-icon-plus" type="primary" @click="pay">结算</el-button>
        <el-footer>
            <el-pagination
