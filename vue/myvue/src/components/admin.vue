    ...
    <div>
      ...
      <el-container style="height: 600px; border: 5px solid #eee">
        ...
        <el-main style="height:0;flex-grow:1;">
            <el-col :span="3">
            <el-input style="margin-left: 10px" width="120" v-model="search" v-on:input ="inputFunc" clearable="true" placeholder="输入关键字搜索"/>
            </el-col>
            ...
            @row-click="openDetails" border>
                ...
                <el-table-column  width="200" label="操作">
                    <template slot-scope="scope">
                        <el-button size="mini" plain icon="el-icon-plus" type="info" @click.native.prevent="deleteRow(scope.$index, tableData)">允许登录</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </el-main>
